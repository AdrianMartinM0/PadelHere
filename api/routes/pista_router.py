...
@pista_router.get("/pista/{pista_id}/reservas")
...
@pista_router.post("/pista/{pista_id}/reservas")
...
@pista_router.get("/pista/{pista_id}/reservas/{reserva_id}")
...
@pista_router.put("/pista/{pista_id}/reservas/{reserva_id}")
...
@pista_router.delete("/pista/{pista_id}/reservas/{reserva_id}")
...
@pista_router.get("/pista/{pista_id}/disponibilidad")
