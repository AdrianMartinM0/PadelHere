    ...
    <div className="bg-white h-full w-full rounded-4xl flex justify-center items-center relative">
        ...
        <div className="bg-[#00000099] w-4/5 h-4/5 rounded-4xl flex flex-col justify-evenly items-center absolute">
          <div className="flex flex-col justify-center items-center">
            <p className="text-white text-3xl">¿Eres un club?</p>
            <p className="text-white text-3xl">Solicita formar parte de PadelHere</p>
          </div>
          <button className="text-white p-2 px-4 bg-[#006FFF] rounded-lg">Solicitar</button>
        </div>
    </div>
  )
}
