# PadelHere - Project Context (AGENTS.md)

Este documento contiene el contexto técnico verificado del proyecto PadelHere, destinado a orientar a los agentes de IA y desarrolladores en el mantenimiento y evolución del sistema.
